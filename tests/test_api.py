...
from naruto.models import User,Role,Post,Comment,Follow
...
class APITestCase(unittest.TestCase):
    ...
    def test_posts(self):
        ...
        u=User(email='john@example.cn',password='cat',confirmed=True,role=r)
        db.session.add(u)
        db.session.commit()
        ...
        response=self.client.post(
                              ...
                              headers=self.get_api_headers('john@example.cn','cat'),
